...
const BILL_MODE = "certified_bill";
  ...
  const handleOrderSelect = useCallback(async (value) => {
    ...
    try {
      const res = await apiRequest({
        url:    `${API_ENDPOINTS.PROJECT.SALE_CERTIFIED_BILL.ORDER_LOOKUP}?ogSaleOrderNo=${encodeURIComponent(value)}&projectCode=${projectCode}&mode=${BILL_MODE}`,
        method: "GET",
      });
      const d = res.data || {};
