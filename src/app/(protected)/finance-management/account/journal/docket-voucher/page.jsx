...
/**
 * Journal → Voucher Docket (list)
 *
 * The same module as Petty Cash → Voucher Docket: same APIs, same form, same
 * columns. Only the permission source differs — these pages check the "journal"
 * page permission, while the petty-cash copy checks "petty_cash".
 */
...
export default function JournalDocketVoucherListPage() {
    ...
    apiRequest({
      ...
      .then((res) => {
        ...
        const rows = list.map((r, i) => ({
          ...
          amount:         formatAmount(r.totalAmount || 0),
    ...
    <HeaderWrapper header={<PageHeader actions={actions} />}>
      <div className="p-3 space-y-3">
        <SearchSection
          ...
          actions={
            access.canAdd
              ? [{ label: "+ Voucher Docket", onClick: () => router.push(`${BASE_PATH}/new`) }]
              : []
          }
        />
