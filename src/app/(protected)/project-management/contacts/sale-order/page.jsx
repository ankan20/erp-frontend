...
export default function Page() {
  ...
  const access  = getPageAccess({ pageCode: "sale_order", pageType: "LIST" });
    ...
    const fetchList = async () => {
      try {
        const res = await apiRequest({
          url:    `${API_ENDPOINTS.PROJECT.OG_SALE_ORDER.LIST}?projectCode=${projectCode}`,
          method: "GET",
        });
        ...
        toast.error("Failed to fetch Sale Order list");
      } finally {
        setLoading(false);
      }
    };
